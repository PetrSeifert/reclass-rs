...
impl FieldType {
    ...
    pub fn get_size(&self) -> u64 {
        match self {
            ...
            FieldType::Hex32 | FieldType::Int32 | FieldType::UInt32 | FieldType::Float | FieldType::Vector2 => 4,
    ...
    pub fn is_hex_type(&self) -> bool {
        matches!(self, FieldType::Hex64 | FieldType::Hex32 | FieldType::Hex16 | FieldType::Hex8)
    }
